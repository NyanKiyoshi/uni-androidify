...
public final class GroupAssociations {
    public static final String EXTRA_GROUPS_TO_REMOVE =
            "com.example.TPNotemkocak.controllers.adapters.GroupAdapter.EXTRA_GROUPS_TO_REMOVE";
    public static final String EXTRA_GROUPS_TO_ADD =
            "com.example.TPNotemkocak.controllers.adapters.GroupAdapter.EXTRA_GROUPS_TO_ADD";
    ...
    private static void populateSelectedGroupsBundle(
            Bundle bundle, ArrayList<Integer> toAdd, ArrayList<Integer> toRemove, RemovableAdapter<BaseModel> adapter) {
    ...
    public static Bundle applyGroups(
        ...
        if (contact == null || contact.groups == null) {
            populateSelectedGroupsBundle(results, toAdd, toRemove, adapter);
        } else {
